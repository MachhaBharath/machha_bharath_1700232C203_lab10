# -*- coding: utf-8 -*-
"""Lab_Assignment_8_Bharath

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NjIR4ZZRUB7UgReyXEQnWU2WRk_k1gWv

**NAME:**MAchha Subha Bharath
**ENROLLMENT NO:**1700232C203
**CSE-2**
"""
...
"""Department variable has a huge effect on attrition varible and this will be useful for modelling and prediction.
When compared to R&D the employees of HR and Sales are comperatively low.
"""
...
"""LifeSciences and Medical has the large number of employees 
and attrition rate also.The % of employees who have been attritioned and who have been retained are also same in all education fields.
"""
...
"""People in Joblevel 4 have a very high percent for a 'No' 
and a low percent for a 'Yes'. Similar inferences can be made for other job levels.
"""
...
"""we can notice that the relative percent of 'No' in people with higher grade of environment satisfacftion.
This can be done for all the features further but i feel this are some of the important features,which can be used aganist our target class
"""
