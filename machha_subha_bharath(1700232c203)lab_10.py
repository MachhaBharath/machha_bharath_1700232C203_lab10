# -*- coding: utf-8 -*-
"""Machha_Subha_Bharath(1700232C203)LAB - 10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Tq1KLjIrdhJm7pZvA61LYcGfLtyl7P3C
"""
...
for z in range(n_features):
  X_z = scipy.stats.norm.rvs(0, 1, 100)
  X.append(X_z)
...
X = []
for p in range(n_features_of_the_model):
...
for p in a1:
  if (p>=0.5):
    ...
    y1.append(0)
data_nl = {'X0': X[0],'X1':X[1],'X2':X[2],'X3':X[3],'Y': y1 }
nd = pd.DataFrame(data_nl)
print(df.head())
print(df.tail())
print(df.info())
print(df.describe())
...
X_s= -2 * np.random.rand(100,2)
X_r = 1 + 2 * np.random.rand(50,2)
X_s[50:100, :] = X_r
plt.scatter(X_s[ : , 0], X_s[ :, 1], s = 50)
plt.show()
data_kmeans = {'X0': X_s[:,0],'X1':X_s[:,1]}
